 ...
 */
declare function FormList(version: V2): FormListInstance;
...
declare class FormContext {
   ...
   * @param formType - The Type of this Form
   */
  constructor(version: V2, formType: FormFormTypes);
...
declare class FormInstance extends SerializableClass {
   ...
   * @param formType - The Type of this Form
   */
  constructor(version: V2, payload: FormPayload, formType: FormFormTypes);
...
declare class FormPage extends Page<V2, FormPayload, FormResource, FormInstance> {
  /**

...
import { BucketList } from 'twilio/lib/rest/verify/v2/service/rateLimit/bucket';
...
declare class RateLimitContext {
   ...
   * @param callback - Callback to handle processed record
   */
  update(callback?: (error: Error | null, items: RateLimitInstance) => any): Promise<RateLimitInstance>;
  /**
   * update a RateLimitInstance
   *
   * @param opts - Options for request

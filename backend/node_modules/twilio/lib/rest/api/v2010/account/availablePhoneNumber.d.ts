...
import { LocalList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/local';
import { LocalListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/local';
import { MachineToMachineList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/machineToMachine';
import { MachineToMachineListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/machineToMachine';
import { MobileList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/mobile';
import { MobileListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/mobile';
import { NationalList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/national';
import { NationalListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/national';
import { SerializableClass } from 'twilio/lib/interfaces';
import { SharedCostList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/sharedCost';
import { SharedCostListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/sharedCost';
import { TollFreeList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree';
import { TollFreeListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/tollFree';
import { VoipList } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/voip';
import { VoipListInstance } from 'twilio/lib/rest/api/v2010/account/availablePhoneNumber/voip';
